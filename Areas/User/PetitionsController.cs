...
namespace TheCause.Areas.User
{
    ...
    public class PetitionsController : Controller
    {
        ...
        // GET: User/Petitions/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: User/Petitions/Create
